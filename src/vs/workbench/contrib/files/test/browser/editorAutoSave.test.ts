...
import { TestFilesConfigurationService, TestServiceAccessor, createEditorPart, registerTestFileEditor, workbenchInstantiationService } from 'vs/workbench/test/browser/workbenchTestServices';
