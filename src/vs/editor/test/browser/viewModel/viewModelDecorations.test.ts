...
describe('ViewModelDecorations', () => {
	test('getDecorationsViewportData', () => {
      ...
      expect(viewModel.getLineContent(1)).toBe('hello world, ')
      expect(viewModel.getLineContent(2)).toBe('this is a ')
      expect(viewModel.getLineContent(3)).toBe('buffer that ')
      expect(viewModel.getLineContent(4)).toBe('will be ')
      expect(viewModel.getLineContent(5)).toBe('wrapped')
